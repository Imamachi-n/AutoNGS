...
for filepath in cuffdiff_result_list:
    ...
    cmd_1 = "cp {0}/cuffdiff_result_mRNA.txt RNA-seq_NCBI_GEO_repository/cuffdiff/{1}_{2}_mRNA.txt".format(filepath, file_dir, file_name)
...
for filepath in cuffdiff_result_list:
    ...
    cmd_1 = "cp {0}/cuffdiff_result_mRNA.txt RNA-seq_NCBI_GEO_repository/cuffdiff/{1}_{3}_{2}_mRNA.txt".format(filepath, file_dir, file_name, file_type)
    subprocess.call(cmd_1, shell = True)
